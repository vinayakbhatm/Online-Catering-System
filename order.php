...
<html>
<head>
    <title>Catering System - Order</title>
    <meta charset="utf-8">
...
if(isset($_POST["fullname"]) && isset($_POST["mobile"]))
{
    ...
    $menuitems = mysqli_real_escape_string($link, $_POST['Menu']);
    ...
    $datetime = mysqli_real_escape_string($link, $_POST['datetime']);
        ...
        $sql = "INSERT INTO sh_order(sh_fullname, sh_email, sh_mobile, sh_companyname, sh_budget, sh_people, sh_function, sh_menu, sh_service, sh_menuitems, sh_addressvenue, sh_datetime) VALUES ('$fullname', '$email', '$mobile', '$company', '$budget', '$people', '$function', '$menu', '$service', '$menuitems', '$addressvenue', '$datetime')";
                ...
                <div class="col span_1_of_3">
				  <div class="contact-form">
				  	<h3>Preferences</h3>
						    ...
						    <div>
						    	<span><label>Prefered Menu (*)</label></span>
                ...
                <div class="col span_1_of_3">
				  <div class="contact-form">
				  	<h3>Preferences</h3>
                            ...
                            <div>
						    	<span><label>Menu required (*)</label></span>
						    	<span><textarea name="Menu" required> </textarea></span>
						    </div>
						    <div>
